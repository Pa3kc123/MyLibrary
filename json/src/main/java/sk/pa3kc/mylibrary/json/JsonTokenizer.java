...
public class JsonTokenizer {
    ...
    JsonTokenizer(char[] arr) {
        this(new CharArrayReader(arr));
    }
    ...
    public int next() throws JsonException {
        int c;
            ...
            switch (c) {
                ...
                case '\\':
                    ...
                    switch (c) {
                        ...
                        case 'u':
                            try {
                                builder.append((char)Integer.parseInt(new String(nextCharRange(4)), 16));
                        ...
                        case '/':
                            builder.append(c);
                        break;
                        default: throw new JsonException("Illegal escape.");
                    }
                break;
                case '"':
